...
class Autentifikasi extends CI_Controller
{
    ...
    public function registrasi()
    {
        ...
        $this->form_validation->set_rules
        ('email', 'Alamat Email', 'required|trim|valid_email|is_unique[user.email]', [
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata(
                'pesan', '<div class="alert alert-success alert-message" role="alert">Selamat!! akun member anda sudah dibuat. Silahkan Aktivasi Akun anda</div>');redirect('autentifikasi');
            }
        }
    }